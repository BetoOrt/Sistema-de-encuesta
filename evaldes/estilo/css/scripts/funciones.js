...
$(function() {
	...
	$(document).on("click", "a#grafGrupo", function(){ graficaGrupos(this); });	
});
...
function graficaGrupos(element) {
	var fol=$(element).attr('folio');
	var mat=$(element).attr('materia');
	openWindowWithPost("indexGraficaGrupo.php", "_blank",new Array("grafProf","grafMat"),new Array(fol,mat));
}
