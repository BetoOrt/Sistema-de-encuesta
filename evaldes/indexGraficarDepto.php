...
///Inicia la gráfica.
   ...
   echo "   <center>";
	...
	///Filtrando las encuestas del Profesor 
	   ...
	   $SQL='SELECT DEP_NOM,respuestas FROM '.$cfg['EncuestasAlumnos'].' INNER JOIN ConvertirDeptosaClave ON depto=CDC_CVE INNER JOIN '.$cfg['DDEP'].' ON CDC_DEP=DEP_CVE WHERE depto="'.$_POST["grafDepto"].'" ORDER BY folio;';
