...
{  unset($imprimir); include("configuracion.php"); $año=$cfg['año']; $semestre=$cfg['semestre']; $tec=$cfg['instituto']; $lema=$cfg['lema']; $index=$cfg['index']; unset($cfg);
   ?>
<!DOCTYPE html>
<html lang="es">
<head>
