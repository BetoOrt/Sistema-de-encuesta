...
**************************************************************************/
   ...
   $cfg['añoperiodo']           = $cfg['año'].strtolower($cfg['periodo']);   //Año y periodo de captura
	$cfg['baseañoperiodo']       = $cfg['base'].'.'.$cfg['añoperiodo'];
   //Tablas
   $cfg['EncuestasAlumnos']     = $cfg['baseañoperiodo'].'EncuestasAlumnos';    //Encuestas de Alumnos
   $cfg['EncuestasPosgrado']    = $cfg['baseañoperiodo'].'EncuestasPosgrado1';   //Encuestas de Posgrado
   $cfg['EncuestasRegistrados'] = $cfg['baseañoperiodo'].'EncuestasRegistrados'; //Alumnos ya Registrados en la Encuesta
   $cfg['Fallos']               = $cfg['baseañoperiodo'].'Fallos';               //Fallos en la Encuesta
   $cfg['Preguntas']            = $cfg['baseañoperiodo'].'Preguntas';            //Preguntas en la Encuesta
   $cfg['PreguntasRubros']      = $cfg['baseañoperiodo'].'PreguntasRubros';      //Rubros de las Preguntas en las Encuesta
   $cfg['GruposaContinuo']      = $cfg['baseañoperiodo'].'GruposaContinuo';      //Rubros de las Preguntas en las Encuesta
